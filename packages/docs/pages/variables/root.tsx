...
import { Spacing, Text, Table } from '@bedrock-ui/core';
...
function VariablesRoot() {
  ...
  return (
    <DocSection name="Root Variables">
      <Text>
        These are all the global CSS variables that Bedrock UI provides. They primarily serve as the
        basis of the theme colors, and while these variables and the variables specific to
